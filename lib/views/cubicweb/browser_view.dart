...
class _BrowserViewState extends State<BrowserView> {
  ...
  /// setState bridge for part-file extensions: protected [State.setState]
  /// isn't callable from extensions, so parts refresh through this.
  void refreshBrowserUi(VoidCallback fn) => setState(fn);
